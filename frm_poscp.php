...
<p align="center" class="style4">Alterando a posi&ccedil;&atilde;o atual de um Produto <br>
  <span class="style8">Movimenta&ccedil;&atilde;o de Produtos</span></p>
<?
if(isset($erro)){print("<h1><font color='red'>".$erro."</h1></font>");}
?>
<form name="form1" method="post" action="scr_poscp.php">
  <p align="center">
  ...
  <table width="599" border="0" align="center">
    ...
    <tr>
      <td class="style4">Nova Posi&ccedil;&atilde;o :</td>
      <td><span class="style2">
        <select name="cmbMotivo" class="style2" id="select6"  tabindex="5" >
            <option value="0"></option>
            <?	  
$sql="select * from posicao where inventario=0 and ativo=1";

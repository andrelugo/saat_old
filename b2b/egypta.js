...
tr(false);
writeButton(loc+"","con_entrada_saida.php","egypta_b1",186,30,"Entrada e saída mensal","mainFrame",0);
writeButton(loc+"","con_pendencias.php","egypta_b2",186,30,"Visualize pendências On-Line","mainFrame",0);

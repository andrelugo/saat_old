...
///////////////////////////////////////////////////////////////
///  Alterei em 25/09/05 o source das imagens preto e branco para a pasta img -- linha 146
//////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////
///  Alterei em 25/09/05 o source das imagens preto e branco para a pasta img
//////////////////////////////////////////////////////////////
		function produceHTML($text="",$alignment=0,$height=60,$width=1,$bImg="img/b.gif",$wImg="img/w.gif") {
			
			$ticketArray = $this->produceArray($text);
			
			$html ="<table cellpadding=3 cellspacing=0 border=0 bgcolor=white><tr><td>";
			...
			if ( is_array($ticketArray) ) {
				...
				foreach ( $ticketArray as $k=>$v ) {
					...
					for ( $qq=0; $qq < strlen($info); $qq++ ) {
						...
						if ( !$alignment ) {
							$html .= "<img src=\"". $color[intval($on)] ."\" height=\"$height\" width = \"".floor( $info[$qq] * $width )."\">";
						}
						else {
							$html .= "<img src=\"". $color[intval($on)] ."\" width=\"$height\" height = \"".floor( $info[$qq] * $width )."\"><br>";
						}
...
//// TESTES REALIZADOS EM 25/09/05 DAQUI PARA BAIXO DEVE SER EXCLUIDO E UTILIZADO EM OUTRAS PÁGINAS QUE INCLUAM ESTE CÓDIGO
//$cod = new code128();
//print $cod->produceHTML("fer",0,20,1);
//print $cod->produceHTML("fer123",0,20,1);
?>
